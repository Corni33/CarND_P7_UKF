...
void UKF::Initialize(MeasurementPackage measurement_pack) {
  ...
  if (measurement_pack.sensor_type_ == MeasurementPackage::RADAR) {
    ...
    // rho is a distance measurement, so the standard deviation of x- and y-position should be roughly in the magnitude of std_radr_
    // v, phi, phi_dot are initialized with high uncertainty as we cannot determine them from a single measurement 
...
void UKF::ProcessMeasurement(MeasurementPackage measurement_pack) {
  ...
  if (measurement_pack.sensor_type_ == MeasurementPackage::RADAR && use_radar_) {
    ...
    ****************************/
    ...
    std::cout << "predicted! (Radar measurement), dt=" << dt << std::endl;
...
void UKF::UpdateRadar(MeasurementPackage meas_package) {
  ...
  */
  ...
  if (export_NIS_) {
    ...
    //write to file
    nis_file_ << "R," << NIS << std::endl;
  }

}

double UKF::CalculateNIS(const VectorXd &z_diff, const MatrixXd &S) {
